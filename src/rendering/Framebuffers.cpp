...
static GLint getDepth(ShadowMapRes depthRes) noexcept
{
	switch (depthRes) {
	case ShadowMapRes::BITS_16: return GL_DEPTH_COMPONENT16;
	case ShadowMapRes::BITS_24: return GL_DEPTH_COMPONENT24;
	case ShadowMapRes::BITS_32: return GL_DEPTH_COMPONENT32;
	}
	...
	mHasPCF{pcf}
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, getDepth(depthRes), resolution, resolution, 0,
